...
function Home() {
    return (
        <div className="App">
            <main>
                <section id="hero" className="bg-primary text-white text-center py-5 py-lg-6">
                        ...
                        <Row className="justify-content-center">
                            <Col md={10} lg={8}>
                                ...
                                <div className="d-grid gap-3 d-sm-flex justify-content-sm-center animate__animated animate__fadeIn">
                                    <Button variant="warning" size="lg" className="rounded-pill px-4 py-2 shadow-sm" href="https://wa.me/554133829576"> 
                                        {FaWhatsapp({ className: "center" })} Solicitar atendimento
                                    </Button>
                                    <Link to="/acompanhamento-os" style={{ textDecoration: 'none' }}>
                                        <Button variant="outline-light" size="lg" className="rounded-pill px-4 py-2 shadow-sm">
                ...
                <section id="servicos" className="py-5 py-lg-6 bg-light">
                    <Container>
                        ...
                        <Row xs={1} md={2} lg={3} className="g-4"> {/* Grid responsivo com espaçamento */}
                            {[
                                {
                                ...
                                <Col key={i}>
                                    <Card className="h-100 text-center shadow-sm border-0 transform-on-hover">
                                        <Card.Body className="p-4">
                                            <div className="fs-1 mb-3 text-primary">{servico.icon}</div> {/* Ícone maior */}
                ...
                <section id="contato" className="py-5 py-lg-6 bg-light">
                    <Container>
                        <h2 className="text-center mb-5 fw-bold text-primary">Fale com a gente</h2>
                        <Row className="justify-content-center">
                            <div className="bg-white p-4 rounded shadow-sm h-100">
                                <h3 className="fs-5 fw-semibold mb-3 text-primary">Siga-nos</h3>
                                <div className="d-flex justify-content-center justify-content-md-start gap-3">
                                    <a href="https://wa.me/554133829576" target="_blank" rel="noopener noreferrer">
                                        {FaWhatsapp({ className: "text-success fs-3" })}
                                    </a>
                                    <a href="https://www.youtube.com/@aiconinformatica4862" target="_blank" rel="noopener noreferrer" >
                                        {FaYoutube({ className: "text-danger fs-3" })}
                                    </a>
                                    <a href="https://www.instagram.com/aiconbr" target="_blank" rel="noopener noreferrer">
                                ...
                                <div className="mt-3">
                                    <div
                                        style={{
                                            position: 'relative',
                                            paddingBottom: '22.5%', // Reduz a altura do mapa para ~40% do original
                                            height: 0,
                                            overflow: 'hidden',
                                            borderRadius: '8px',
                                ...
                                <p className="mb-2"><b>
                                    Rua Visconde do Rio Branco, 2737 - Centro -
                                    São José dos Pinhais/PR
                                </b></p>
                                <a
                                    href="https://www.google.com/maps/search/?api=1&query=Rua Visconde do Rio Branco,+2737,+Centro,+S%C3%A3o+Jos%C3%A9+dos+Pinhais,+PR" // Substitua pelo endereço real
                                    target="_blank"
